(function (root, factory) {
  ...
  */
  var YouTubeVideoPlayerAudit = function(options) {
    ...
    this.iframeIds = options.ids || this._getYoutubePlayers();
        ...
        player = new YT.Player(self.iframeIds[i],{
          events: {
            "onStateChange": (function(){
              return function() {
                self._userActed.apply( self, Array.prototype.slice.call( arguments ) );
              }
            })()
          }
        });
